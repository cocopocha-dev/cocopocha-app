...
---
## 2026-04-15 00:44:44 (update)
cocopocha LAB です
半角大文字小文字は守って下さい。

もっと動きをつけて、ページが斜めにカットインするイメージ。
アプリを開発するチームなので、開発したアプリ実績をメインとしてトップに配置、自動で画像がスライドするように。
画像はとりあえず、イメージが分かるように添付したものを画像配置する予定のところ全部に配置


---
## 2026-04-15 00:59:13 (update)
進捗は？


---
## 2026-04-15 18:29:37 (update)
ホームページをドライブに保存して


---
## 2026-04-15 18:30:17 (update)
ホームページをドライブに保存して


---
## 2026-04-15 18:40:58 (update)
ホームページをドライブに保存して


---
## 2026-04-15 19:37:10 (update)
ホームページをドライブに保存して
